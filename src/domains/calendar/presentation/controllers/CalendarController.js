...
class CalendarController {
  ...
  createCalendar = asyncHandler(async (req, res) => {
    const { CreateCalendarDTO } = require('../../application/dto');
  ...
  updateCalendar = asyncHandler(async (req, res) => {
    const { UpdateCalendarDTO } = require('../../application/dto');
  ...
  linkGoogleCalendars = asyncHandler(async (req, res) => {
    const { LinkGoogleCalendarsDTO } = require('../../application/dto');
  ...
  setPrimaryGoogleCalendar = asyncHandler(async (req, res) => {
    const { SetPrimaryGoogleCalendarDTO } = require('../../application/dto');
  ...
  linkGoogleAccount = asyncHandler(async (req, res) => {
    const { LinkGoogleAccountDTO } = require('../../application/dto');
  ...
  selectGoogleCalendars = asyncHandler(async (req, res) => {
    const { SelectGoogleCalendarsDTO } = require('../../application/dto');
  ...
  createCalendarMapping = asyncHandler(async (req, res) => {
    const { CreateCalendarMappingDTO } = require('../../application/dto');
  ...
  listGoogleEvents = asyncHandler(async (req, res) => {
    const { ListGoogleEventsDTO } = require('../../application/dto');
  ...
  getFreeBusy = asyncHandler(async (req, res) => {
    const { GetFreeBusyDTO } = require('../../application/dto');
  ...
  getUnifiedCalendar = asyncHandler(async (req, res) => {
    const { GetUnifiedCalendarDTO } = require('../../application/dto');
  ...
  getMonthlyCalendar = asyncHandler(async (req, res) => {
    const { GetMonthlyCalendarDTO } = require('../../application/dto');
  ...
  backfillSync = asyncHandler(async (req, res) => {
    const { BackfillSyncDTO } = require('../../application/dto');
  ...
  startWatch = asyncHandler(async (req, res) => {
    const { StartWatchDTO } = require('../../application/dto');
  ...
  stopWatch = asyncHandler(async (req, res) => {
    const { StopWatchDTO } = require('../../application/dto');
  ...
  getSharedCalendarView = asyncHandler(async (req, res) => {
    const { GetSharedCalendarViewDTO } = require('../../application/dto');
