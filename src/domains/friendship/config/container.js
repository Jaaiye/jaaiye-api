...
// Infrastructure
const { FriendshipRepository, FriendRequestRepository } = require('../infrastructure/persistence/repositories');
...
const createFriendshipRoutes = require('../presentation/routes/friendship.routes');

class FriendshipContainer {
  constructor() {
    this._instances = {};
  }
...
module.exports = new FriendshipContainer();
