...
const IFriendRequestRepository = require('../../../domain/repositories/IFriendRequestRepository');
const FriendRequestSchema = require('../../../../shared/infrastructure/persistence/schemas/FriendRequest.schema');
const FriendRequestEntity = require('../../../domain/entities/FriendRequest.entity');
const { FriendRequestNotFoundError } = require('../../../domain/errors');
