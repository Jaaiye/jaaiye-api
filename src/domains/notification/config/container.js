...
const { NotificationRepository } = require('../infrastructure/persistence/repositories');
const { PushNotificationAdapter, DeviceTokenAdapter, FirebaseAdapter } = require('../infrastructure/adapters');
const {
...
const createNotificationRoutes = require('../presentation/routes/notification.routes');
...
module.exports = new NotificationContainer();
