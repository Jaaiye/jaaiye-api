...
const { UserNotFoundError, InvalidPasswordError, EmailAlreadyInUseError, SameEmailError } = require('../../../shared/domain/errors');
...
class UpdateEmailUseCase {
  ...
  async execute(userId, dto) {
    ...
    const verificationCode = AuthPasswordService.generateVerificationCode();
