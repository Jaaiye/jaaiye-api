...
const { IEventRepository } = require('./interfaces');
...
class EventRepository extends IEventRepository {
  ...
  _toEntity(doc) {
    ...
    return new EventEntity({
      ...
      creatorId: docObj.creatorId ? docObj.creatorId.toString() : undefined,
      origin: docObj.origin,
      publishedAt: docObj.publishedAt,
